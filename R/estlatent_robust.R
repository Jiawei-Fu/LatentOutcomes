...
#' @param IV_Y Optional loading-IV names for stage-1 loading GMM. Default uses all regressors from `mod`.
#' @param opt For each GMM stage: TRUE=two-step efficient GMM, FALSE=one-step GMM.
#' @export
estlatent_robust <- function(mod, Y, data = NULL, method = "sem", IV_Y = NULL, opt = TRUE) {
